...
class AppTextStyles {
  ...
  /// Cursive style used for the doctor's rendered signature on the
  /// prescription letterhead (no signature image asset exists).
  static TextStyle get signatureCursive =>
      GoogleFonts.dancingScript(fontSize: 26.sp, fontWeight: FontWeight.w600);
}
